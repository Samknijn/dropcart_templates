...
<div class="row home">
    <div class="col-sm-4 text-center">
        ...
        <div class="imgcolor imgwidth text-center">
            <br/>
            <a href="{{ env('BASE_URL', '/') . 'nl/jettowelslim/' }}" class="btn btn-green btn-width">{{ lang('page_all.moreinfo') }}</a>
        </div>
    </div>
    <div class="col-sm-4 text-center">
        ...
        <div class="imgcolor imgwidth1 text-center">
            <br/>
       <a href="{{ env('BASE_URL', '/') . 'nl/jettowelsmart/' }}" class="btn btn-green btn-width">{{ lang('page_all.moreinfo') }}</a>
        </div>
    </div>
    <div class="col-sm-4 text-center">
    <img class="img-responsive" src="{{ env('BASE_URL', '/') . 'img/jettowelmini.png' }}">
        ...
        <div class="imgcolor imgwidth2 text-center">
            <br/>
            <a href="{{ env('BASE_URL', '/') . 'nl/jettowelmini/' }}" class="btn btn-green btn-width">{{ lang('page_all.moreinfo') }}</a>
        </div>
    </div>
</div>
@endsection